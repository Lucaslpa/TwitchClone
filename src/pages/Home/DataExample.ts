...
export const Recomendação = [
  ...
  {  id: 1 , 
        image: 'https://static-cdn.jtvnw.net/jtv_user_pictures/81c6a1ab-1651-43d5-87a6-de8fe404c5d2-profile_image-70x70.png'
          ,
          Name: 'Keiozin' , 
          Category: 'League of Legends' ,
          Viewers: 2400 ,
...
export const CanaisAoVivoQueAchamosQueVocêVaiGostar = [ 
  {  id: 1, 
    image: image1
      ...
      Viewers: 904,
      Title: 'irl arrumando o setup com o xandeco',
      Tags: 'Português'
 },
 {  id: 2, 
  image: image3
    ...
    Category: 'Terrary' ,
    Viewers: 2400,
    Title: 'Sala de espera CBLOL - =) bundia',
    Tags: 'Português'
},
{  id: 3, 
  image: image2
